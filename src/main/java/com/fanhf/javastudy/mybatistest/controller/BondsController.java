...
public class BondsController {
    ...
    public ResultData getBondsList() {
        List<BondsBean> bondsList = bondsService.getBondsList();

        return new ResultData().setList(bondsList);
    }
    ...
    //指向类加载器的引用 Reference to the class loader
    //指向Class 实例的引用 A reference to a Class instance
